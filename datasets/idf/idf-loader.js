...
function downloadDataset(datasetInfo, format, callback){
  ...
  var dataset_file = "idf/datasets/"+format+"/"+datasetId+"."+format;
...
function run(){
  getAllDatasetIds("idf/idf-datasets.json", function(datasetIds){
